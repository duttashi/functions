# README: This lambda function will check the customer's redit card balance. It will also tell the customer if he/she is late in payment or not.
# To test this function in AWS Lambda console, attach the accompanied test.json script.
...
def lambda_handler(event_data, lambda_config):
    ...
    # Hide/unhide the below code line when using the test script
    # callerId = event_data["sessionAttributes"]["CustomerNumber"]

    # Hide/unhide the below code line when NOT using the test script
    callerId = "+60176043921"
    ...
    table = dynamodb.Table('RICHA_ASH_DEV')
    ...
    if not items:
        ...
        if (intent_name == "checkCreditCardBal"):
            ...
            if (cust_acct_type in ("platinum") or cust_acct_type == "1"):
                ...
                if (cc1_days_left > 0):
                    ...
                    message = 'You have ' + str(
                        acct_balance) + ' ringgit left on your ' + cust_acct_type + ' account.' + 'And you have ' + str(
                        cc1_days_left) + ' day left to settle the bills.'

                elif (cc1_days_left == 0):

                    message = 'You have ' + str(
                        acct_balance) + ' ringgit left on your ' + cust_acct_type + ' account.' + "And, today is last day to pay bills!"

                elif (cc1_days_left < 0):
                    temp = cc1_days_left * -1
                    message = 'You have ' + str(
                        acct_balance) + ' ringgit left on your ' + cust_acct_type + ' account.' + 'You are ' + str(
                        temp) + ' day behind credit bill payment!'
            ...
            # elif (cust_acct_type in ("signature")):
            elif (cust_acct_type in ("signature") or cust_acct_type == "2"):
                ...
                if (cc2_days_left > 0):
                    ...
                    message = 'You have ' + str(
                        acct_balance) + ' ringgit left on your ' + cust_acct_type + ' account.' + 'And you have ' + str(
                        cc2_days_left) + ' day left to settle the bills.'
