...
Instead, ask your question on [Stack Overflow](https://stackoverflow.com/questions/tagged/python)
or the [Python mailing list's](https://www.python.org/community/lists/) mailing list (you must subscribe to post).
...
1. Determine which repository the bug/feature should be reported in. The process
   ...
   issue.
2. Search current open GitHub [issues](https://github.com/duttashi/learnpyml/issues)
...
4. If the bug exists in the HEAD of master, and you can't find an open issue,
   then [open a new issue](https://github.com/duttashi/learnpyml/issues).
   Please be sure to:
